 ...
 * @author AM
 */
@WebServlet(urlPatterns = {"/CookiesAddServlet"})
public class CookiesAddServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CookiesAddServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CookiesAddServlet at " + request.getContextPath() + "</h1>");
            
            String data = request.getParameter("data"); // Get param from HTTP request.
